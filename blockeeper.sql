...
INSERT INTO `sys_dept` VALUES (1,0,'blockeeper.org集团',0,0),(2,1,'长沙分公司',1,0),(3,1,'上海分公司',2,0),(4,3,'技术部',0,0),(5,3,'销售部',1,0);
...
CREATE TABLE `sys_log` (
  ...
  `operation` varchar(50) DEFAULT NULL COMMENT ' Users操作',
  `method` varchar(200) DEFAULT NULL COMMENT '请求方法',
  `params` varchar(5000) DEFAULT NULL COMMENT '请求参数',
  `time` bigint(20) NOT NULL COMMENT '执行时长(毫秒)',
  `ip` varchar(64) DEFAULT NULL COMMENT 'IP地址',
  `create_date` datetime DEFAULT NULL COMMENT '创建 time ',
  PRIMARY KEY (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='系统 Users';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_token` (
  ...
  `expire_time` datetime DEFAULT NULL COMMENT '过期 time ',
  `update_time` datetime DEFAULT NULL COMMENT '更新 time ',
  PRIMARY KEY (`user_id`),
